...
import { BrowseScene } from './illustrations/BrowseScene'
import { ChooseScene } from './illustrations/ChooseScene'
import { ConnectScene } from './illustrations/ConnectScene'
        ...
        <AnimatedSection delay={0.15} className="mt-16 md:mt-20">
          ...
          >
            ...
            {DESIGN_STEPS.map((step, i) => {
              ...
              const isLast = i === DESIGN_STEPS.length - 1
