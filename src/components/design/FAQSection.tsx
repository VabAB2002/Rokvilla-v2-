...
import { DESIGN_FAQS, FAQ_CATEGORIES } from '@/lib/constants/design'
import type { FAQCategory } from '@/lib/constants/design'
...
export function FAQSection() {
  ...
  const [activeCategory, setActiveCategory] = useState<FAQCategory>('design')
  const [openId, setOpenId] = useState<string | null>(null)

  const filteredFaqs = DESIGN_FAQS.filter((f) => f.category === activeCategory)
