...
const ROW_1 = BUILD_KEY_FEATURES.slice(0, 3)
const ROW_2 = BUILD_KEY_FEATURES.slice(3, 6)
...
function FeatureCard({
  ...
  readonly feature: (typeof BUILD_KEY_FEATURES)[number]
  readonly index: number
  readonly isLast: boolean
}) {
  return (
    <div className="group flex flex-col items-center text-center">
      {/* Icon in tinted circle — replaces illustration */}
