...
const DEFAULT_TABS: ReadonlyArray<FilterTab> = [
  { id: 'all', label: 'All' },
...
export function ProjectsSection({
  ...
  const allItems: ReadonlyArray<BaseItem> = items ?? PROJECTS

  const filteredProjects = useMemo(
    () =>
      activeTab === 'all'
        ? allItems
        : allItems.filter((p) => matchesTab(p, activeTab)),
    [activeTab, allItems, matchesTab],
  )
